...
function IdeaDetail() {
  ...
  const padding = windowWidth < 969 ? '10px 0' : '15px 40px'
  ...
  return (
    ...
    <>
      <Layout className="layout" style={{ padding: padding }}>
        <Content style={{ background: 'white', border: '1px solid #ccc', borderRadius: '5px' }}>
          ...
          <MenuBar commentCount={data.commentCount} />
          <Space style={{ padding: '10px 44px' }}>
          ...
          <Space style={{ justifyContent: 'end', display: 'flex', paddingRight: '44px' }}>
            <Button type="primary" shape="round" disabled={false} onClick={() => {}}>
              Comment
            </Button>
          </Space>
        </Content>
